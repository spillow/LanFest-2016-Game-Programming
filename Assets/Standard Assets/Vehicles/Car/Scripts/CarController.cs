...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        public float CurrentSpeed
        {
            get
            {
                switch (m_SpeedType)
                {
                    ...
                    default:
                        Debug.Assert(false, "Unknown speed type!");
                        return 0f;
                }
            }
        }
        ...
        [SerializeField] private float m_SecondJumpTimer;
        [SerializeField] private float m_FirstJumpTime;
        [SerializeField] private float m_FlipFactor;
        [SerializeField] private float m_BoostFactor;
        [SerializeField] private float m_AirRollFactor;
        [SerializeField] private ParticleSystem m_LeftBoostBurn;
        [SerializeField] private ParticleSystem m_RightBoostBurn;
        [SerializeField] private Collider m_TurtleDetector;
        ...
        */
        ...
        private void CheckForWheelSpin()
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                if (i == 0)
                {
                    //Debug.Log("forward slip: " + wheelHit.forwardSlip);
                    //Debug.Log("side slip: " + wheelHit.sidewaysSlip);
                    //Debug.Log("force: " + wheelHit.force);
                    //Debug.Log("forward friction: " + m_WheelColliders[i].forwardFriction);
                }
        ...
        // crude traction control that reduces the power to wheel if the car wheel is spinning too much
