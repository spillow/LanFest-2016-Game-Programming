...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarController : MonoBehaviour
    {
        ...
        [SerializeField]
        private float m_SecondJumpTimer;
        [SerializeField]
        private float m_FirstJumpTime;
        [SerializeField]
        private float m_FlipFactor;
        [SerializeField]
        private float m_BoostFactor;
        [SerializeField]
        private float m_AirRollFactor;
        [SerializeField]
        private ParticleSystem m_LeftBoostBurn;
        [SerializeField]
        private ParticleSystem m_RightBoostBurn;
        [SerializeField]
        private Collider m_TurtleDetector;
